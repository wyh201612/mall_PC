...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'viewInvoice',
        component: () => import('@/views/viewInvoice/index'),
        name: 'viewInvoice',
        meta: { title: '黄金商城-发票详情',auth: true }
      },
      {
        path: 'myAccount',
        ...
        children: [
          ...
          },
          {
            ...
            component: () => import('@/views/tradersPassword/index'),
            meta: { title: '黄金商城-交易密码',auth: true }
          },
          {
            path: 'goldenBeanCenter',
            component: () => import('@/views/goldenBeanCenter/index'),
            meta: { title: '黄金商城-金豆中心',auth: true }
          },
          {
            path: 'goldenBeanExchangeCenter',
            component: () => import('@/views/goldenBeanExchangeCenter/index'),
            meta: { title: '黄金商城-金豆兑换中心',auth: true }
          },
          {
            path: 'goldenBeanExchangeDetailed',
            component: () => import('@/views/goldenBeanExchangeDetailed/index'),
            meta: { title: '黄金商城-金豆兑换明细',auth: true }
          },
          {
            path: 'goldenBeanUseDetailed',
            component: () => import('@/views/goldenBeanUseDetailed/index'),
            meta: { title: '黄金商城-金豆使用明细',auth: true }
          },
          
          {
            path: 'preferentialBenefits',
            component: () => import('@/views/preferentialBenefits/index'),
            meta: { title: '黄金商城-优惠福利中心',auth: true }
          },
          {
            path: 'myTracks',
            component: () => import('@/views/myTracks/index'),
            meta: { title: '黄金商城-我的足迹',auth: true }
          },
      ...
      {
        path: 'serviceCentre',
        component: () => import('@/views/serviceCentre/index'),
        name: 'serviceCentre',
        meta: { title: '黄金商城-服务中心',auth: false }
      },
      {
        path: 'downloadApp',
      ...
      },
      {
        ...
        name: 'noticeList',
        meta: { title: '黄金商城-公告列表',auth: false }
      },
      {
        path: 'noticeDetail',
        component: () => import('@/views/noticeDetail/index'),
        name: 'noticeDetail',
        meta: { title: '黄金商城-公告详情',auth: false }
      },
      { 
        path: '*',
        redirect: '/index'
